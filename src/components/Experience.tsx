      ...
      <div className="container-x">
        <Reveal>
          ...
          <h2 className="heading max-w-2xl">
            Three years of <span className="text-gradient">shipping</span>{" "}
                ...
                <div className="relative pl-12 sm:pl-16">
                  ...
                  <div className="glass glass-hover p-6">
                    <div className="flex flex-wrap items-center justify-between gap-2">
                      ...
                      {job.current && (
                        <span className="inline-flex items-center gap-1.5 rounded-full bg-accent/12 px-3 py-1 text-xs font-semibold text-accent-600 dark:text-accent">
                          <span className="h-1.5 w-1.5 rounded-full bg-accent" />
                          Current
                        </span>
                      )}
                    </div>
                    <div className="mt-0.5 text-sm font-medium text-accent-600 dark:text-accent">
                      {job.company}
                    </div>
                    <div className="mt-1 text-xs muted">{job.period}</div>

                    <ul className="mt-4 space-y-2">
                      {job.points.map((pt) => (
                        <li
                          key={pt}
                          className="flex gap-2.5 text-sm text-black/70 dark:text-white/70"
                        >
